...
public class Interceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		log.info("preHandle()...");
		// 멤버 접속 허용 url 관리
		String memberAllowedPatterns = "/userpage\\.do|/memberreview/json/selectAll\\.do|/memberreview/json/insertOK\\.do|/memberreview/json/updateOK\\.do|/memberreview/json/deleteOK\\.do|/memberreview/json/mre_totalCount\\.do|/party/selectAll\\.do|/party/searchList\\.do|/party/selectOne\\.do|/party/insert\\.do|/party/insertOK\\.do|/party/update\\.do|/party/updateOK\\.do|/party/deleteOK\\.do|/party/myParty\\.do|/party/myPartyPaging.do|/party/json/selectAll\\.do|/party/json/par_totalCount\\.do|/party/json/approveOK\\.do|/shop/review/insert\\.do|/shop/insert\\.do|/shop/review/update\\.do|/shop/review/delete\\.do|/shop/update\\.do|/shop/delete\\.do|/member/json/selectOne\\.do|/member/json/updateOK\\.do|/member/json/deleteOK\\.do|/member/mypage\\.do|/member/selectOne\\.do|/mail/selectAll\\.do|/mail/insert\\.do|/mail/json/selectAll\\.do|/mail/json/newMailCnt\\.do|/mail/json/insertOK\\.do|/mail/json/readOK\\.do";		
