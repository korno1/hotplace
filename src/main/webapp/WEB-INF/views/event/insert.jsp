...
<body>
	...
	<div>
		<div class="eve_title_div">
			<input class="eve_title_insert" type="text" name="title" id="title" placeholder="제목" onfocus="this.placeholder=''" onblur="this.placeholder='제목'" value="" onkeyup="titleCheckByte(this, 100)">
			<span>종료일자</span>
